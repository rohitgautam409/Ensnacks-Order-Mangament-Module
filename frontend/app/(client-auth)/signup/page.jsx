/**
 * Client signup page — creates new corporate client accounts.
 * URL: /signup
 * Calls POST /api/auth/client/signup directly via axios.
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
        ...
        {success ? (
          <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-4">
            <p className="text-green-800 text-center font-medium">✅ Account created successfully! Redirecting to login...</p>
          </div>
        ) : (
